# CVFuzz brand library

This is the canonical home for CVFuzz brand materials.
...
Use `cvfuzz-logo-light.png` on white and CVFuzz Paper. Use `cvfuzz-logo-dark.png` on dark fields
and dark imagery. Use the corresponding `cvfuzz-symbol-*` file only where the compact symbol is
required. Do not recolor, crop, or redraw the supplied master raster logo files.
